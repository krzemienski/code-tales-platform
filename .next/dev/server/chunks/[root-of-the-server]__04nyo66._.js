...
"[project]/app/api/audio/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    ...
    try {
        ...
        const metadata = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$storage$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getFileMetadata"])(path);
        ...
        const stream = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$storage$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getFileStream"])(path);
        if (!stream) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        if (rangeHeader) {
            ...
            if (rangeMatch) {
                ...
                return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"](partialBuffer, {
                    status: 206,
                    headers: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__04nyo66._.js.map