...
"[project]/app/api/stories/[id]/download/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req, { params }) {
    ...
    try {
        const [story] = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["db"].select({
            ...
            audioUrl: __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$schema$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["stories"].audioUrl,
            audioChunks: __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$schema$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["stories"].audioChunks
        ...
        const chunks = story.audioChunks || [];
        ...
        const safeName = (story.title || "story").toLowerCase().replace(/[^a-z0-9]+/g, "-").slice(0, 50);
        return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"](combined, {
            headers: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0a8d1wa._.js.map