...
"[project]/app/api/stories/regenerate-audio/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    ...
    try {
        ...
        if (!story.scriptText) {
            return Response.json({
                error: "Story has no script to synthesize"
            }, {
                status: 400
            });
        }
        ...
        for(let i = 0; i < scriptChunks.length; i++){
            ...
            if (!audioResponse.ok) {
                ...
                return Response.json({
                    error: `ElevenLabs API error on chunk ${chunkNum}`
                }, {
                    status: 500
                });
            }
            ...
            try {
                ...
                return Response.json({
                    error: `Failed to upload chunk ${chunkNum}`
                }, {
                    status: 500
                });
            }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__8cc0ab6d._.js.map